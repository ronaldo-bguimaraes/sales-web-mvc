...
namespace SalesWebMvc.Data
{
  ...
  {
    private SalesWebMvcContext _ctx;
    ...
    public void Seed()
    {
      if (_ctx.Department.Any() || _ctx.Seller.Any() || _ctx.SalesRecord.Any())
      {
      ...
      SalesRecord r01 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s1);
      SalesRecord r02 = new SalesRecord(2, new DateTime(2018, 09, 4), 7000.0, SaleStatus.Billed, s5);
      SalesRecord r03 = new SalesRecord(3, new DateTime(2018, 09, 13), 4000.0, SaleStatus.Canceled, s4);
      SalesRecord r04 = new SalesRecord(4, new DateTime(2018, 09, 1), 8000.0, SaleStatus.Billed, s1);
      SalesRecord r05 = new SalesRecord(5, new DateTime(2018, 09, 21), 3000.0, SaleStatus.Billed, s3);
      SalesRecord r06 = new SalesRecord(6, new DateTime(2018, 09, 15), 2000.0, SaleStatus.Billed, s1);
      SalesRecord r07 = new SalesRecord(7, new DateTime(2018, 09, 28), 13000.0, SaleStatus.Billed, s2);
      SalesRecord r08 = new SalesRecord(8, new DateTime(2018, 09, 11), 4000.0, SaleStatus.Billed, s4);
      SalesRecord r09 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SaleStatus.Pending, s6);
      ...
      _ctx.Department.AddRange(d1, d2, d3, d4);

      _ctx.Seller.AddRange(s1, s2, s3, s4, s5, s6);

      _ctx.SalesRecord.AddRange(r01, r02, r03, r04, r05, r06, r07, r08, r09, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30);
